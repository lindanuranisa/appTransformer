...
<form method="post" action="{{ route('comments.store') }}">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary"
                                       ...
                                       <a href="https://twitter.com/<?= $project->name ?>?ref_src=twsrc%5Etfw" class="twitter-follow-button" data-show-count="false">Follow @<?= $project->name ?></a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                            </div>
                        </form>
